...
class HonestViewSet(viewsets.GenericViewSet):
    ...
    def is_valid(self, request):
        ...
        url_login = "https://www.honestfund.kr/login"
    ...
    def account(self, request):
        ...
        # 마이페이지에 접근하기
        url_mypage = "https://www.honestfund.kr/mypage/investor/investments"
    ...
    def balance(self, request):
        ...
        residual_investment_price = res.json()['data']['investResult']['outstandingPrincipal'] + res.json()['data']['investResult']['receivedLateFee']
