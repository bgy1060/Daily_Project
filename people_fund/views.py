...
class PeopleViewSet(viewsets.GenericViewSet):
    ...
    def balance(self, request):
        ...
        residual_investment_price = res.json()['data']['reportInfo']['accumulatedRepaymentProfit'] \
                                    + res.json()['data']['reportInfo']['accumulatedRepaymentOverdueProfit'] \
                                    - res.json()['data']['reportInfo']['accumulatedRepaymentCommission'] \
                                    - res.json()['data']['reportInfo']['accumulatedRepaymentTax'] \
                                    + res.json()['data']['reportInfo']['accumulatedRepaymentPrincipal']
