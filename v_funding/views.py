...
class VFundingViewSet(viewsets.GenericViewSet):
    ...
    def is_valid(self, request):
        ...
        url_login = "https://www.vfunding.co.kr/bbs/login_check.php"
    ...
    def account(self, request):
        ...
        data = soup.select('div.myinfo_box2 ul.info_com em')
    ...
    def balance(self, request):
        ...
        number_of_investing_products = soup.select("ul.clear span")[0].text.strip()
