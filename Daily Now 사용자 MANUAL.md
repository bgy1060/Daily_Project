...
- [로그인](#3-로그인)
- [커뮤니티](#4-커뮤니티)
  - [게시글 작성과 수정 및 삭제](#2-사용자는-커뮤니티에-게시글을-생성-조회-수정-삭제-할-수-있다)
  - [댓글, 답글 작성과 수정 및 삭제](#3-사용자는-게시글에-대한-댓글을-생성-조회-수정-삭제-할-수-있다)
- [FAQ](#5-faq)
- [마이페이지](#6-마이페이지)
  - [프로필](#세부-프로필)
    - [회원 정보 변경](#설정)
...
### 1. 초기 화면(DAILY NOW 메인 화면)
   ...
   <img src ="https://lh3.googleusercontent.com/txEZkx5KX3RZ6FTyDd5cW0fzEaWaqtkAG27S0E0sqxlfJ7N-6fALrV9C0nzylF2R9q5HNORXnV94P6d0Clb6Ryi09mQq6K_h4877dbUEcFkR-TuVuQHyx2W4ultZiBTf0DeItqJA" width='650' height ='400'>
...
### 2. 회원가입
   ...
   - 카카오톡 친구 초대를 통해 가입할 경우 자동으로 Invited Code가 생성된다. 
     ...
     <br />
     <img src ="https://lh6.googleusercontent.com/X3KSlPm3KLKA992jTKHUKRjV9k-F26lTUZwRaYCh8_-c5DCkA_5c9nG9D302JAYzqgmnFngvabqoQkt5ECHXQTYiZA1N_nTDhOhQo3316D3WenpQX2gjUYLAX84YqOql4Re26SHo" width='650' height ='600'>
...
### 3. 로그인
   ...
   - 아이디와 비밀번호를 입력하고 로그인 버튼을 눌러 메인 화면으로 이동한다. 
     ...
     <br />
     <img src ="https://lh6.googleusercontent.com/G5MRPYlQpxEjBY1zcW5wsVA_dLyXAikpHKnMCsPafU441rkO0KclW-wdk7a35qvXTR-yoeDGP-05qegS4zhcrFsTcOwUgR7GoB46Yu5f_KwGChoBCEb9FYeQtOfriK9JxPUEPDZc" width='670' height ='450'>
...
#### 2. 사용자는 커뮤니티에 게시글을 생성, 조회, 수정, 삭제 할 수 있다.

  - Row per page의 숫자를 조정하여 한 페이지에 가져올 글 수를 지정할 수 있다.
...
#### 3. 사용자는 게시글에 대한 댓글을 생성 조회, 수정, 삭제 할 수 있다.
  ...
  <br />
  <img src = "https://lh5.googleusercontent.com/xvF0N5hzV23aE9B9PXOOd9rITKsSh79v8s0zsEQ8aqIfTidlpWPSG3tz2J1EkCofL5mNEMhpUoACLQA7vmLkW-1qI_CQEdGG64bOqngLSyrLByoQV2nb3bapG4C0p0B70OLSBC13"  width='700' >
  <br />
  ...
  <br />
  ​<img src = "https://lh3.googleusercontent.com/g9UzTju2-BZ21zZRnz8vhD65em2h7rIEqru1iAW_cR5u6VWeXQtBkGYiQ04gTpJk4Tjv84V8d1UIadbGncnmoR865Lx5DD26ltPWQCPpz1ZAOodXnAz0muxQvulLgh15_n9OrtC1"  width='700' >
...
### 5. FAQ
  ...
  <br />
  <img src = "https://lh5.googleusercontent.com/nlxWeP72q-Wd3GgsMiQGbE9CoEK1d93CRwO3QnJP4f7okAcG3ctAuf9ILmeN_8LJM19YdSNFqwaKhKkS1zRlmwWJgmUU2sB3o5iKVwah436I_Fi1ONMegVSO2R0SY7MCPABJeNaK"  width='700'  >
...
### 6. 마이페이지
  ...
  - 사용자는 로그인을 완료한 후, Daily Now 마이페이지를 이용할 수 있다.
    ...
    <img src = "https://lh5.googleusercontent.com/--gwQABH7qDgqWBSB114oxPKTGEEK8E9Q9dUNUzbcvP1XWsbaqkYXyQXcVnPDixXVeUL-4H80pMuFfcxWaoeM1op0wHw5a1iBVeRvbvFwhoYQe-aYdoxPYaw-iKpxlrU-HzYlAUG"  width='700' >
...
<br /><br />
  ...
  - 달력 모양 아이콘을 누르면 다음과 같은 창에서 조회일을 수정할 수 있다.
    ...
    ![img](https://lh5.googleusercontent.com/Bn_TYpXrCwrWq2sUoNh0UPgKDiiBytOgSqp1s_7ZlHfdkh2h2K_iHhrsSV8nYNSGcy8pKusRI_y26Y0Yn6YaZFg75dlC4ZYTEcjpI8BANct6RH2wo5Bm9keubPBRG9QLOYOp133Z)
  ...
  - 화살표 ^ 모양 아이콘을 선택하면, 간편하게 맨 위로 이동한다. 
    ...
    <img src = "https://lh4.googleusercontent.com/qVJt5nQqzPZh4tq2FMdU8itdgF-O_0BNs3Bl_jRxhA4pC1nJaDSTaojf2BbKU1CEdSaQjQL9kO196zk2ZUnZUpQhrotR8OiGEdwwy9rIQfzW3Rs_qihiK4FheEUwZuQ4VprK7aQT"  width='700'>
